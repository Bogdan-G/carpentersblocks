package com.carpentersblocks.blocks;

import com.carpentersblocks.CarpentersBlocks;
import com.carpentersblocks.CbBakedModel;
import com.carpentersblocks.BlockRegistry;
import com.carpentersblocks.UnlistedPropertyBlockAvailable;
...
public class CarpentersBlock extends Block {
    ...
    public void initModel() {
        ...
        StateMapperBase ignoreState = new StateMapperBase() {
            ...
            protected ModelResourceLocation getModelResourceLocation(IBlockState iBlockState) {
                return CbBakedModel.BAKED_MODEL;
            }
        };
    ...
    public void initItemModel() {
        ...
        Item itemBlock = Item.REGISTRY.getObject(new ResourceLocation(CarpentersBlocks.MODID, "bakedmodelblock"));
    ...
    private boolean isSameBlock(IBlockAccess world, BlockPos pos) {
        return world.getBlockState(pos).getBlock() == BlockRegistry.carpentersBlock;
    }
